        ...
        return Scaffold(
          ...
          body: Column(
            children: [
              ...
              Expanded(
                child: controller.weaknessOptions.isEmpty
                    ? const Center(child: Text('暂无薄弱点选项'))
                    : ReorderableListView.builder(
                        padding: const EdgeInsets.all(16),
                        itemCount: controller.weaknessOptions.length,
                        onReorder: controller.reorderWeaknessOptions,
                        itemBuilder: (context, index) {
                          final item = controller.weaknessOptions[index];
